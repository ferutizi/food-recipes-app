...
export default function SearchBox() {
	...
	return (
		<form onSubmit={handleSubmit} className='flex flex-col items-center sm:inline-block'>
			<input
				defaultValue={searchParams.get('q') || ''}
				className='mx-0 mb-2 sm:mb-8 m-8 me-0 w-96 sm:w-72 md:w-96 h-10 rounded-2xl sm:rounded-e-none outline-none pl-4 text-black'
				name="query"
